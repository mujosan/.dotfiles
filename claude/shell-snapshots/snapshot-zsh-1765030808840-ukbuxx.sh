...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/usr/local/Caskroom/claude-code/2.0.60/claude --ripgrep'
fi
export PATH='/Users/martin/.cargo/bin:/usr/local/opt/ruby/bin:/opt/homebrew/bin:/opt/homebrew:/usr/local/opt/ruby@3.0/bin:/usr/local/lib/ruby/gems/3.0.0/bin:/usr/local/sbin:/usr/local/opt/curl/bin:/usr/local/bin:/System/Cryptexes/App/usr/bin:/usr/bin:/bin:/usr/sbin:/sbin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin:/opt/pmk/env/global/bin:/Library/Apple/usr/bin:/Applications/Little Snitch.app/Contents/Components:/Applications/Wireshark.app/Contents/MacOS:/Users/martin/.lmstudio/bin'
